...
bool MessageInfo::serialize_to(std::string* dst) const {
...
bool MessageInfo::serialize_to(char* dst, std::size_t len) const {
...
bool MessageInfo::deserialize_from(const std::string& src) {
    return deserialize_from(src.data(), src.size());
}

bool MessageInfo::deserialize_from(const char* src, std::size_t len) {
